...
public interface UnsortedListInterface <Type> extends ListInterface <Type>{
	...
	void find(Type target);						//Searches list for an occurrence of an element such that 	
	...
	boolean contains(Type element);				// Returns true if this list contains an element e such that
	...
	boolean remove(Type element);				// Removes an element  from this list such that e.equals(element)
	 ...
	 Type getNext() ;							// Preconditions: The list is not empty
